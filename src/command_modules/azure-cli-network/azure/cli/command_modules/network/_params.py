...
def load_arguments(self, _):
    ...
    with self.argument_context('network application-gateway waf-config') as c:
        ...
        c.argument('firewall_mode', min_api='2016-09-01', help='Web application firewall mode.', default=ApplicationGatewayFirewallMode.detection.value, arg_type=get_enum_type(ApplicationGatewayFirewallMode))
    ...
    with self.argument_context('network lb') as c:
        ...
        c.argument('sku', min_api='2017-08-01', help='Load balancer SKU', arg_type=get_enum_type(LoadBalancerSkuName), default=LoadBalancerSkuName.basic.value)
    ...
    for item in ['create', 'update']:
        with self.argument_context('network public-ip {}'.format(item)) as c:
            ...
            c.argument('version', min_api='2016-09-01', help='IP address type.', default=IPVersion.ipv4.value, arg_type=get_enum_type(IPVersion))

...
def load_command_table(self, _):
    ...
    with self.command_group('network vnet-gateway vpn-client', client_factory=cf_virtual_network_gateways) as g:
        g.custom_command('generate', 'generate_vpn_client')
        g.custom_command('show-url', 'get_vpn_profile_package_url', min_api='2017-08-01')
